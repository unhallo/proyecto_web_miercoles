...
<html lang="en">
  ...
  <body>
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
		      <a class="navbar-brand" href="/index.php"><span class="flaticon-pizza-1 mr-1"></span>Comidi<br><small>Ticas</small></a>
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 ftco-animate">
            	<img src="tamal.jpg" class="img-fluid" alt="">
            </div>
    ...
    <div class="overlay"></div>
      <div class="container">
        ...
        amor por la tradición y compromiso con la calidad. Desde nuestras manos a su mesa, en ComidiTicas, celebramos la pasión por la comida 
